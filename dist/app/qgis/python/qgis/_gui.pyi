...
class QgsDataItemGuiProvider(PyQt5.sip.wrapper):
    ...
    @staticmethod
    def notify(title: str, message: str, context: QgsDataItemGuiContext, level: _core.Qgis.MessageLevel = ...) -> None: ...
...
class QgsProcessingAbstractParameterDefinitionWidget(QtWidgets.QWidget):
...
class QgsSvgSelectorWidget(QtWidgets.QWidget):
    ...
    def sourceLineEdit(self) -> QgsSvgSourceLineEdit: ...
